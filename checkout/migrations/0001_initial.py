    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('taggings', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='checkout.tag')),
            ],
        ),
        migrations.AddField(
            model_name='item',
            name='tags',
            field=models.ManyToManyField(blank=True, through='checkout.Tagging', to='checkout.Tag'),
        ),
        migrations.AddField(
            model_name='item',
            name='user',
